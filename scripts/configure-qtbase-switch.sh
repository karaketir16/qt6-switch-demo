...
BUILD_DIR="${2:-/Volumes/T7/sdk/qt6-switch-build/qtbase-widgets-test}"
TOOLCHAIN_FILE="${3:-${REPO_ROOT}/extras/toolchain-switch.cmake}"
QT_HOST_PATH_VALUE="${QT_HOST_PATH:-${4:-/Volumes/T7/sdk/qt6-host-build-linux/qtbase}}"
...
if [ -z "${QT_HOST_PATH_VALUE}" ]; then
    ...
    echo "Example: QT_HOST_PATH=/Volumes/T7/sdk/qt6-host-build-linux/qtbase ./configure-qtbase-switch.sh" >&2
    exit 1
fi
